...
function UpdateDoctors() {
  ...
  <div className="flex justify-center items-center min-h-screen bg-gray-50 p-4">
      ...
      <form onSubmit={handleSubmit} className="w-full max-w-lg p-8 bg-white shadow-xl rounded-lg border border-gray-100">
        
        <h2 className="text-2xl font-bold mb-6 text-gray-800 border-b pb-2">Update Doctor Profile</h2>
